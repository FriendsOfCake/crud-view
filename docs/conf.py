...
project = u'crud-view'
project_pretty_name = u'Crud View'
...
latex_documents = [
    ('index', 'crud-view.tex', u'crud-view',
     u'Friends Of Cake', 'manual'),
]
man_pages = [
    ('index', 'crud-view', u'Crud View Documentation',
     [u'Friends Of Cake'], 1)
]

texinfo_documents = [
    ('index', 'crud-view', u'Crud View Documentation',
     u'Friends Of Cake', 'crud-view', 'Admin generator for CakePHP',
     'Miscellaneous'),
]
